...
S0_system:      equ     $F040               // Address of top of Calc Stack
TIB_system      equ     $F040               // TIB grows upwards, Return-Stack downward.
R0_system:      equ     $F0E0               // Address of top of Return Stack. This is S0 + $00A0
USER_system:    equ     $F0E0               // User variables zone.
FIRST_system:   equ     $F13C               // Address of first BUFFER
LIMIT_system:   equ     $FF58               // Address of first byte beyond last BUFFER
